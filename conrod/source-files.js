...
sourcesIndex["conrod_gfx"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["conrod_glium"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["conrod_piston"] = {"name":"","dirs":[],"files":["draw.rs","event.rs","lib.rs"]};
sourcesIndex["conrod_winit"] = {"name":"","dirs":[],"files":["lib.rs"]};
...
sourcesIndex["smithay_client_toolkit"] = {"name":"","dirs":[{"name":"data_device","dirs":[],"files":["data_device.rs","data_offer.rs","data_source.rs","mod.rs"]},{"name":"keyboard","dirs":[],"files":["ffi.rs","keysyms.rs","mod.rs"]},{"name":"pointer","dirs":[],"files":["mod.rs","theme.rs"]},{"name":"utils","dirs":[],"files":["mempool.rs","mod.rs"]},{"name":"window","dirs":[{"name":"shell","dirs":[],"files":["mod.rs","wl.rs","xdg.rs","zxdg.rs"]}],"files":["basic_frame.rs","concept_frame.rs","mod.rs"]}],"files":["env.rs","lib.rs","output.rs","surface.rs"]};
sourcesIndex["stable_deref_trait"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["stb_truetype"] = {"name":"","dirs":[],"files":["lib.rs"]};
sourcesIndex["syn"] = {"name":"","dirs":[{"name":"gen","dirs":[],"files":["gen_helper.rs"]}],"files":["attr.rs","buffer.rs","data.rs","derive.rs","error.rs","expr.rs","file.rs","generics.rs","item.rs","lib.rs","lifetime.rs","lit.rs","mac.rs","macros.rs","op.rs","parse_quote.rs","parsers.rs","path.rs","punctuated.rs","spanned.rs","synom.rs","token.rs","tt.rs","ty.rs","verbatim.rs"]};
